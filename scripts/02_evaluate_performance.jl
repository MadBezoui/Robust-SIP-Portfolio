...
function evaluate_backtest(trans_cost::Float64=0.0010, tau::Float64=0.05)
    ...
    rets_dict = Dict{String, Vector{Union{Float64, Missing}}}()
    rets_gross_dict = Dict{String, Vector{Union{Float64, Missing}}}()
    turnover_dict = Dict{String, Vector{Union{Float64, Missing}}}()
    weights_dict = Dict{String, Vector{Vector{Union{Float64, Missing}}}}()
