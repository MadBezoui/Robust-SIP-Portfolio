...
\textit{Proof is provided in Appendix A.1.}
...
\textit{Proof is provided in Appendix A.2.}
...
\textit{Proof is provided in Appendix A.3.}
...
\textit{Proof is provided in Appendix A.4.}
...
\subsection*{A.1 Proof of corresponding theorem/lemma}
\begin{proof}
If $N\bar w<1$, then
\begin{equation}
...
\subsection*{A.2 Proof of corresponding theorem/lemma}
\begin{proof}
...
\subsection*{A.3 Proof of corresponding theorem/lemma}
\begin{proof}
...
\subsection*{A.4 Proof of corresponding theorem/lemma}
\begin{proof}
