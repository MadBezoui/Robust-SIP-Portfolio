...
using CSV, DataFrames, Dates, Statistics, LinearAlgebra, JuMP, Clarabel, OSQP
...
for t_start in step_indices
    ...
    t_highs = @elapsed res_highs = solve_min_variance(cov_mat, mu, target_return, max_weight; optimizer=Clarabel.Optimizer)
