...
"""
function solve_min_variance(cov_mat::Matrix{Float64}, mu::Vector{Float64}, target_return::Float64, max_weight::Float64=1.0, w_prev::Union{Vector{Float64}, Nothing}=nothing, turnover_limit::Float64=2.0; optimizer=Clarabel.Optimizer)
    N = size(cov_mat, 1)
